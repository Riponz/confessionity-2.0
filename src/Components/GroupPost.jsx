...
function GroupPost({ gid, username }) {
    ...
    return (
        <>
                <ToastContainer />
            <section className='w-full rounded-lg my-1 flex justify-center items-center bg-white py-6'>
                {console.log(username)}
                <textarea onChange={(e) => { setContent(e.target.value) }} name="" id="" className='bg-[#e5e7eb] outline-none rounded-xl w-[80%] p-2 mb-3' placeholder='your content goes here...' rows={5} />
