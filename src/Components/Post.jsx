    ...
    return (
        <>
            <section className='w-full rounded-lg my-1 flex flex-col justify-evenly items-center bg-white py-6'>
                <ToastContainer />
                <textarea onChange={(e) => { setContent(e.target.value) }} value={content} name="" id="" className='bg-[#e5e7eb] outline-none rounded-lg w-[80%] p-4 mb-3' placeholder='your content goes here...' rows={5} />
